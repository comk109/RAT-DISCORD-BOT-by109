...
# 🎯 Key Components
1. Bot Setup
BOT_TOKEN = "YOUR_DISCORD_BOT_TOKEN_HERE"  # Bot's identity
CHANNEL_ID = YOUR_CHANNEL_ID_HERE          # Channel to listen
WEBHOOK_URL = "https://discord.com/api/webhooks/..."  # Command relay
LOG_CHANNEL = YOUR_LOG_CHANNEL_ID_HERE     # Log channel
...

{
    ...
    "hidden": "https://discord.com/api/webhooks/YOUR_HIDDEN_WEBHOOK_HERE", # webhook hidden 
    "bot_token": "YOUR_DISCORD_BOT_TOKEN_HERE", # token bot discord 
    "channel_id": "YOUR_DISCORD_CHANNEL_ID_HERE" # id channel 
}
